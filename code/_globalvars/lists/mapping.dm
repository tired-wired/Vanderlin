...
GLOBAL_LIST_EMPTY(roundstart_landmarks)			//list of all roundstart spawn points created
GLOBAL_LIST_EMPTY(latejoin_landmarks)			//list of all latespawn points created
